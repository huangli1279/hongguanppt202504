...
import { detailedIndustryGrowthData } from '@/data';
import { TrendingUp, Factory, Building2 } from 'lucide-react';
...
export const ContentSlide06: React.FC = () => {
  return (
    <BaseContentSlide
      ...
      cards={
        <>
          <BaseCard title="信息与租赁服务业双位数高增" icon={TrendingUp} delay="100ms">
            <p>
