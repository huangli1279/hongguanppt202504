        ...
        <>
          <BaseCard title="消费需求平稳增长" delay="0ms" variant="accent">
            <p>
              ...
              <span className="font-bold text-black">2.4个百分点</span>，贡献GDP增长
          ...
          <BaseCard title="投资结构持续优化" delay="120ms">
            <p>
              ...
              <span className="font-bold text-black">1.9个百分点</span>，贡献率达
          ...
          <BaseCard title="净出口韧性彰显但贡献占比有限" delay="600ms">
            <p>
              一季度货物和服务净出口拉动GDP增长
              <span className="font-bold text-black">0.8个百分点</span>，出口总额同比增长
              <span className="text-black">14.7%</span>，对GDP增长的贡献率
