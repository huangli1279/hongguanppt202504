      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6 flex-shrink-0">
          ...
          <BaseCard title="国有控股投资优于民间投资" delay="120ms">
            <p>
              一季度，国有控股投资同比增长<span className="text-webank-accent font-semibold">7.1%</span>，与“两重”建设、大规模设备更新及项目资金前置支持有关。民间投资同比下降<span className="text-red-500 font-semibold">2.2%</span>，反映民间投资意愿依然低迷。
            </p>
          </BaseCard>
        </div>
