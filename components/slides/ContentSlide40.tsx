...
import { unemploymentRateData, flexibleEmploymentData, workTypeExpenditureData, employmentData } from '@/data/employment';
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 min-h-0">
                <BaseBarChart
                  ...
                  yAxisTickFormatter={(val) => `${(val / 10000).toFixed(2)}亿`}
                  unit="万人"
                  showLabels={true}
