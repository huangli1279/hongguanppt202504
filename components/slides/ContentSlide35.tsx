      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-2 gap-4 mb-4 flex-shrink-0">
          ...
          <BaseCard title="消费信贷结构分析" delay="120ms" variant="accent">
            <p>
              居民信贷中经营贷季度增长7854亿，同比少增366亿；消费贷本季度下降4887亿，同比少增7103亿（居民信贷少增主因），其中短期消费贷同比少增2780亿，中长期消费贷同比少增4222亿。短期消费贷少主要因为居民主动降负债有效信贷需求不足，中长期消费贷少增主要与实体经济中房地产销售低迷，居民购房加杠杆意愿尚未实质性恢复。
            </p>
          </BaseCard>
        </div>
