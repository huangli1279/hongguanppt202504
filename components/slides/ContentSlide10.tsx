      ...
      cards={
        <>
          <BaseCard title="工业增加值及分项" delay="0ms">
            <p>
              上半年规上工业增加值累计同比 <span className="font-bold">5.4%</span>，二季度制造业仍为主要支撑，采矿业累计增速由一季度末 <span className="font-bold">6.0%</span> 降至 <span className="font-bold">3.6%</span>，电热燃水累计增速由一季度末 <span className="font-bold">4.3%</span> 回升至 <span className="font-bold">5.5%</span>。
            </p>
          </BaseCard>
