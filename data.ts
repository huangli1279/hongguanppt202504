...
export const industryDivergenceTableData: IndustryGrowthTableData = {
  title: "2025年分行业规模以上工业增加值当月同比",
  source: "国家统计局",
  unit: "%",
  timeSeries: ["2025-03", "2025-04", "2025-05", "2025-06", "2025-07", "2025-08", "2025-09", "2025-10", "2025-11", "2025-12"],
  industryData: {
    "煤炭开采和洗选业": [10.6, 6.3, 5.5, 6.5, 4.2, 5.1, 6.4, 6.5, 7.5, 6.4],
    "石油和天然气开采业": [6.8, 4.3, 5.3, 3.6, 4.1, 4.7, 8.9, 1.9, 5.1, 3.7],
    "金属矿采选业": [12.7, 9.9, 10.3, 6.2, 11.5, 7.1, 4.9, 5.9, 9.0, 3.2],
    "非金属矿采选业": [9.3, 6.6, 5.1, 14.0, 13.2, 8.5, 3.1, 6.2, 6.1, 3.7],
    "制造业": [7.1, 7.0, 6.7, 6.4, 3.8, 2.0, 6.5, 2.1, 5.6, 5.5],
    "石油煤炭及其他燃料加工业": [4.8, 0.6, 5.4, 11.7, 12.4, 10.2, 10.4, 3.7, 3.7, 6.6],
    "化学原料和化学制品制造业": [8.8, 8.0, 5.9, 7.5, 7.2, 7.6, 9.0, 6.7, 6.7, 8.0],
    "医药制造业": [1.2, 2.2, 1.3, 2.7, 2.4, 3.3, 5.4, -1.6, -2.4, 7.0],
    "化学纤维制造业": [7.6, 6.0, 5.4, 6.7, 4.8, 3.5, 5.3, 3.3, 3.5, 4.2],
    "橡胶和塑料制品业": [0.9, 0.4, -0.6, -3.2, -0.6, 0.5, 0.2, -1.8, -1.8, 0.2],
    "非金属矿物制品业": [7.7, 5.8, 4.8, 4.1, 8.6, 7.3, 2.2, 1.4, 0.9, 0.7],
    "黑色金属冶炼和压延加工业": [7.7, 5.8, 4.8, 9.2, 8.6, 9.1, 8.4, 3.7, 4.8, 4.8],
    "有色金属冶炼和压延加工业": [6.5, 7.5, 8.1, 9.3, 6.8, 2.8, 4.0, 7.3, 5.0, 3.6],
    "金属制品业": [9.9, 7.7, 6.7, 7.8, 4.2, 7.3, 9.3, 2.4, 7.5, 7.5],
    "通用设备制造业": [9.3, 7.8, 6.3, 7.8, 8.4, 7.3, 9.3, 6.9, 7.5, 8.3],
    "汽车制造业": [19.0, 17.6, 14.6, 10.1, 13.7, 12.0, 10.3, 15.2, 11.9, 4.3],
    "铁路船舶航空航天和其他运输设备制造业": [13.0, 13.4, 11.0, 11.4, 10.2, 9.8, 7.9, 5.2, 4.4, 11.8],
    "电气机械和器材制造业": [13.1, 10.8, 10.2, 11.0, 10.2, 9.9, 11.3, 8.9, 9.2, 11.8],
    "装备制造业": [7.7, 7.6, 6.6, 10.1, 6.4, 7.3, 8.8, 7.5, 9.9, 7.6],
    "高技术制造业": [7.9, 7.8, 9.4, -3.8, 8.6, 10.0, -0.4, 10.0, 11.3, -2.8]
  }
};
