...
// 工业分化数据 - 各行业规模以上工业增加值当月同比
export interface IndustrialDifferentiationDataPoint {
  indicator: string;
  '2025-03': number | null;
  '2025-04': number | null;
  '2025-05': number | null;
...
export const industrialDifferentiationData: IndustrialDifferentiationDataPoint[] = [
  { indicator: '煤炭开采和洗选业', '2025-03': 10.6, '2025-04': 6.3, '2025-05': 5.5, '2025-06': 6.5, '2025-07': 4.2, '2025-08': 5.1, '2025-09': 6.4, '2025-10': 6.5, '2025-11': 7.5, '2025-12': 6.4 },
  { indicator: '石油和天然气开采业', '2025-03': 6.8, '2025-04': 4.3, '2025-05': 5.3, '2025-06': 3.6, '2025-07': 4.1, '2025-08': 4.7, '2025-09': 8.9, '2025-10': 1.9, '2025-11': 5.1, '2025-12': 3.7 },
  { indicator: '黑色金属矿采选业', '2025-03': 12.7, '2025-04': 9.9, '2025-05': 10.3, '2025-06': 10.0, '2025-07': 11.5, '2025-08': 7.1, '2025-09': 4.9, '2025-10': 5.9, '2025-11': 9.0, '2025-12': 3.2 },
  { indicator: '有色金属矿采选业', '2025-03': 9.3, '2025-04': 6.6, '2025-05': 5.1, '2025-06': 14.0, '2025-07': 13.2, '2025-08': 8.5, '2025-09': 3.1, '2025-10': 6.2, '2025-11': 6.1, '2025-12': 3.7 },
  { indicator: '农副食品加工业', '2025-03': 5.4, '2025-04': 7.3, '2025-05': 7.6, '2025-06': 8.2, '2025-07': 5.6, '2025-08': 4.7, '2025-09': 6.0, '2025-10': 2.5, '2025-11': 1.7, '2025-12': 3.2 },
  { indicator: '家具制造业', '2025-03': -3.7, '2025-04': -7.1, '2025-05': -7.6, '2025-06': -5.4, '2025-07': -5.8, '2025-08': -7.2, '2025-09': -5.2, '2025-10': -8.9, '2025-11': -11.3, '2025-12': -9.7 },
  { indicator: '化学原料和化学制品制造业', '2025-03': 8.8, '2025-04': 8.0, '2025-05': 5.9, '2025-06': 7.5, '2025-07': 7.2, '2025-08': 7.6, '2025-09': 9.0, '2025-10': 7.1, '2025-11': 6.7, '2025-12': 8.0 },
  { indicator: '医药制造业', '2025-03': 1.2, '2025-04': 2.2, '2025-05': 1.3, '2025-06': 2.7, '2025-07': 2.4, '2025-08': 3.3, '2025-09': 5.4, '2025-10': -1.6, '2025-11': 2.4, '2025-12': 7.0 },
  { indicator: '橡胶和塑料制品业', '2025-03': 7.6, '2025-04': 6.0, '2025-05': 5.4, '2025-06': 6.7, '2025-07': 4.8, '2025-08': 3.5, '2025-09': 5.3, '2025-10': 2.1, '2025-11': 3.3, '2025-12': 4.2 },
  { indicator: '非金属矿物制品业', '2025-03': 0.9, '2025-04': 0.4, '2025-05': -0.6, '2025-06': -0.1, '2025-07': -0.6, '2025-08': 0.5, '2025-09': 0.2, '2025-10': -3.2, '2025-11': -1.8, '2025-12': 0.2 },
  { indicator: '黑色金属冶炼和压延加工业', '2025-03': 7.7, '2025-04': 5.8, '2025-05': 4.8, '2025-06': 4.1, '2025-07': 8.6, '2025-08': 7.3, '2025-09': 2.2, '2025-10': 1.4, '2025-11': 0.9, '2025-12': 0.7 },
  { indicator: '有色金属冶炼和压延加工业', '2025-03': 6.5, '2025-04': 7.5, '2025-05': 8.1, '2025-06': 9.2, '2025-07': 6.8, '2025-08': 9.1, '2025-09': 8.4, '2025-10': 3.7, '2025-11': 4.8, '2025-12': 4.8 },
  { indicator: '金属制品业', '2025-03': 9.9, '2025-04': 7.7, '2025-05': 6.7, '2025-06': 6.7, '2025-07': 4.2, '2025-08': 2.8, '2025-09': 4.0, '2025-10': 1.7, '2025-11': 3.0, '2025-12': 3.6 },
  { indicator: '通用设备制造业', '2025-03': 9.3, '2025-04': 7.8, '2025-05': 6.3, '2025-06': 7.8, '2025-07': 8.4, '2025-08': 7.3, '2025-09': 9.3, '2025-10': 6.9, '2025-11': 7.5, '2025-12': 7.5 },
  { indicator: '汽车制造业', '2025-03': 11.5, '2025-04': 9.2, '2025-05': 11.6, '2025-06': 11.4, '2025-07': 8.5, '2025-08': 8.4, '2025-09': 16.0, '2025-10': 16.8, '2025-11': 11.9, '2025-12': 8.3 },
  { indicator: '铁路、船舶、航空航天和其他运输设备制造业', '2025-03': 19.0, '2025-04': 17.6, '2025-05': 14.6, '2025-06': 10.1, '2025-07': 13.7, '2025-08': 12.0, '2025-09': 10.3, '2025-10': 15.2, '2025-11': 11.9, '2025-12': 9.2 },
  { indicator: '电气机械和器材制造业', '2025-03': 13.0, '2025-04': 13.4, '2025-05': 11.0, '2025-06': 11.4, '2025-07': 10.2, '2025-08': 9.8, '2025-09': 7.9, '2025-10': 4.9, '2025-11': 4.4, '2025-12': 4.3 },
  { indicator: '计算机、通信和其他电子设备制造业', '2025-03': 13.1, '2025-04': 10.8, '2025-05': 10.2, '2025-06': 11.0, '2025-07': 10.2, '2025-08': 9.9, '2025-09': 11.3, '2025-10': 8.9, '2025-11': 9.2, '2025-12': 11.8 },
  { indicator: '装备制造业', '2025-03': null, '2025-04': 9.8, '2025-05': 9.0, '2025-06': null, '2025-07': 8.4, '2025-08': 8.1, '2025-09': null, '2025-10': 8.0, '2025-11': 7.7, '2025-12': null },
  { indicator: '高技术制造业', '2025-03': 10.7, '2025-04': 10.0, '2025-05': 8.6, '2025-06': 9.7, '2025-07': 9.3, '2025-08': 9.3, '2025-09': 10.3, '2025-10': 7.2, '2025-11': 8.4, '2025-12': 11.0 },
  { indicator: '石油、煤炭及其他燃料加工业', '2025-03': 4.8, '2025-04': 0.6, '2025-05': 5.4, '2025-06': 11.7, '2025-07': 12.4, '2025-08': 10.2, '2025-09': 10.4, '2025-10': 8.1, '2025-11': 3.7, '2025-12': 6.6 },
];

// Slide07 专用：分行业增加值当季同比增速（按行业横排）
export const industryGrowthByIndustryRecentData = [
