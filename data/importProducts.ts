...
export interface ImportStatisticsData {
  product: string;
  decAmount: number | string;
  yearTotalAmount: number | string;
  yearQtyYoY: number | string;
  yearAmountYoY: number | string;
}
...
export const importStatisticsData: ImportStatisticsData[] = [
  ...
  { product: '矿产品*', decAmount: '-', yearTotalAmount: '-', yearQtyYoY: '-', yearAmountYoY: 11.3 },
  { product: '铁矿砂及其精矿', decAmount: 10430.5, yearTotalAmount: 31694.3, yearQtyYoY: 10.5, yearAmountYoY: 11.3 },
  { product: '战略性资源*', decAmount: '-', yearTotalAmount: '-', yearQtyYoY: '-', yearAmountYoY: 167.5 },
